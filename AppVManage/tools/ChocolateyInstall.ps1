...
Install-ChocolateyZipPackage -PackageName 'appvmanage' -Url 'http://www.tmurgent.com/appv/Images/Tools/AppV_Manage/V3/Setup_AppV_Manage_4.0.0.0.zip' -UnzipLocation "$packageToolsPath";
## Install Msi
