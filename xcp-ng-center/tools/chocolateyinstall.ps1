...
$url        = 'https://github.com/xcp-ng/xenadmin/releases/download/v20.04.01.33/XCP-ng-Center-20.04.01.33.msi' # download url, HTTPS preferred
...
$packageArgs = @{
  ...
  softwareName  = 'XCP-ng Center*' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
